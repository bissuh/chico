...
# Loads BEEHIIV_API_KEY and BEEHIIV_PUBLICATION_ID from .env at repo root.
...
: "${BEEHIIV_PUBLICATION_ID:?BEEHIIV_PUBLICATION_ID missing from .env}"

API_BASE="https://api.beehiiv.com/v2"
PUB_PATH="/publications/$BEEHIIV_PUBLICATION_ID"
