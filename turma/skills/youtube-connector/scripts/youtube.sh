...
# Travels with the turma:youtube-connector skill.
# Loads YOUTUBE_API_KEY and YOUTUBE_CHANNEL_ID from the host project's
# .env (searched from this script's parent up to the project root).
...
# a separate OAuth flow and are out of scope for this connector.
#
# Usage:
#   ./scripts/youtube.sh <subcommand> [args]
#
# Subcommands:
#   channel                 Channel snapshot (subs, views, video count)
