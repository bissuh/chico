#!/usr/bin/env python3
"""
Upload every stitched short in outbox/assets/finished/{channel_slug}/ to Postiz.
Captures the returned hosted URL and writes outbox/assets/postiz_uploads.json
...
Usage:
    ...
    ./upload_finished.py alex_hormozi  # only this channel

Requires: postiz CLI installed, POSTIZ_API_KEY in repo .env (loaded externally).
"""
...
FINISHED_DIR = REPO_ROOT / "outbox" / "assets" / "finished"
    ...
    for channel_dir in channel_dirs:
        ...
        for video in videos:
            ...
            ledger[ledger_key] = {
                "channel_slug": slug,
                "video_id": video_id,
                "local_path": str(video.relative_to(REPO_ROOT)),
